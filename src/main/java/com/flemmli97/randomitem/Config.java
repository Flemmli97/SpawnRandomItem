...
public class Config {
    ...
    public static List<String> blackList = Lists.newArrayList("minecraft:command_block", "minecraft:structure_void", "minecraft:structure_block", "minecraft:barrier", "minecraft:mob_spawner", "minecraft:enchanted_book",
            "minecraft:chain_command_block", "minecraft:repeating_command_block", "minecraft:filled_map", "minecraft:knowledge_book", "minecraft:written_book", "minecraft:bedrock", "minecraft:command_block_minecart");
